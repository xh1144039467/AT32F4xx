...
{
    hspi1.SPI_TransMode = SPI_TRANSMODE_FULLDUPLEX;
    hspi1.SPI_Mode = SPI_MODE_MASTER;
    hspi1.SPI_FrameSize = SPI_FRAMESIZE_8BIT;
    hspi1.SPI_CPOL = SPI_CPOL_HIGH;
    hspi1.SPI_CPHA = SPI_CPHA_2EDGE;
    hspi1.SPI_NSSSEL = SPI_NSSSEL_SOFT;
    hspi1.SPI_MCLKP = SPI_MCLKP_8;
    hspi1.SPI_FirstBit = SPI_FIRSTBIT_MSB;
    hspi1.SPI_CPOLY = 0;
    SPI_Init(FLASH_SPI, &hspi1);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef *spiHandle)
{
    ...
    */
    ...
    GPIO_InitStruct.GPIO_Pins = SPIx_PIN_MOSI;
    GPIO_InitStruct.GPIO_MaxSpeed = GPIO_MaxSpeed_10MHz;
    GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AF_PP;
    GPIO_Init(SPIx_PORT_MOSI, &GPIO_InitStruct);

    GPIO_InitStruct.GPIO_Pins = SPIx_PIN_MISO;
    GPIO_InitStruct.GPIO_MaxSpeed = GPIO_MaxSpeed_10MHz;
    GPIO_InitStruct.GPIO_Mode = GPIO_Mode_IN_FLOATING;
    GPIO_Init(SPIx_PORT_MISO, &GPIO_InitStruct);

    GPIO_InitStruct.GPIO_Pins = SPIx_PIN_NSS;
    GPIO_InitStruct.GPIO_MaxSpeed = GPIO_MaxSpeed_10MHz;
    GPIO_InitStruct.GPIO_Mode = GPIO_Mode_OUT_PP;
    GPIO_Init(SPIx_PORT_NSS, &GPIO_InitStruct);

    GPIO_InitStruct.GPIO_Pins = SPIx_PIN_SCK;
    GPIO_InitStruct.GPIO_MaxSpeed = GPIO_MaxSpeed_10MHz;
    GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AF_PP;
    GPIO_Init(SPIx_PORT_SCK, &GPIO_InitStruct);
