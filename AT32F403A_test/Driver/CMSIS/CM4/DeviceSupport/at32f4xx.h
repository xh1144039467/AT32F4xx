/**
  ...
  **************************************************************************
  */
/***************************这三句是定义在Keil C++ 中的Define中的************************************/
//( AT32F403AVGT7,USE_STDPERIPH_DRIVER,AT_START_F403A_V1_0 )

#ifndef AT32F403AVGT7         //这个主要是适配不同芯片
#define AT32F403AVGT7
//#define AT32F421G8U7
#endif

#define USE_STDPERIPH_DRIVER  //这个主要是
#define AT_START_F403A_V1_0   //这个主要是适配不同的开发板硬件的适配
